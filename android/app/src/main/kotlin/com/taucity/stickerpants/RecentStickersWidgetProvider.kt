...
/**
 * 2x4 homescreen widget: transparent — the user's three most recent
 ...
 * 2x2 widget only: three flippers would triple the binder payload for
...
class RecentStickersWidgetProvider : HomeWidgetProvider() {
    ...
    /// than the 2x2 minute-hand (three flippers share the budget);
        ...
        appWidgetIds.forEach { widgetId ->
            ...
            val views = RemoteViews(
                ...
                artIds.forEachIndexed { index, viewId ->
                    ...
                    if (art != null) {
                        // Blurred, upsized halo (2x4 only): soft overlay
